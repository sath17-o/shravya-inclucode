...
export const curriculumApi = {
  ...
  studentRevisions: (courseId: string, signal?: AbortSignal) => request<StudentRevisionLibrary>(`/student/courses/${courseId}/revisions`, { signal }),
  studentRevision: (courseId: string, contextId: string, signal?: AbortSignal) => request<StudentOverview>(`/student/courses/${courseId}/revisions/${contextId}`, { signal }),
