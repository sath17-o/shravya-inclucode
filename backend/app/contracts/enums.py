...
class UploadIntentStatus(StrEnum):
    PREPARED = "PREPARED"
    MEDIA_PLACED = "MEDIA_PLACED"
    RECORDING_COMMITTED = "RECORDING_COMMITTED"
    COMPLETED = "COMPLETED"
    RECOVERY_CONFLICT = "RECOVERY_CONFLICT"
...
class RecordingWorkflowStatus(StrEnum):
    UPLOADED = "UPLOADED"
    TRANSCRIBING = "TRANSCRIBING"
    TRANSCRIPT_READY = "TRANSCRIPT_READY"
    NEEDS_REVIEW = "NEEDS_REVIEW"
    MANUAL_TRANSCRIPT_REQUIRED = "MANUAL_TRANSCRIPT_REQUIRED"
    APPROVED = "APPROVED"
    FAILED = "FAILED"
